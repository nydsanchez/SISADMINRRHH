<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmpleadosOpSimultaneo.aspx.cs" Inherits="NominaRRHH.Presentacion.EmpleadosOpSimultaneo" MaintainScrollPositionOnPostback="true" %>
    ...
    <div class="container mar-top">
        <div class="panel panel-info">
            <div class="panel-body">
                ...
                <asp:Label class="control-label" for="focusedInput" ID="Label1" runat="server" Text="Operadores Simultaneos" Style="font-weight: 700"></asp:Label>
                <div class="row">
                    <div class="col-md-12">
                        <ul class="nav nav-tabs">
                             <li class="active"><a href="#registro" data-toggle="tab" aria-expanded="true">Distribucion</a></li>
                            <li class=""><a href="#consulta" data-toggle="tab" aria-expanded="false">Consulta</a></li>                           
                            <li class=""><a href="#edicion" data-toggle="tab" aria-expanded="false">Edicion por Fecha</a></li>
                        ...
                        <div id="myTabContent" class="tab-content paddingTab">
                            <div class="tab-pane fade active in" id="registro">
                                <asp:Label class="control-label" for="focusedInput" ID="Label3" runat="server" Text="Configurar Distribucion" Style="font-weight: 700"></asp:Label>
                                 <br />
                            ...
                            <div class="tab-pane fade" id="consulta">
                                <asp:Label class="control-label" for="focusedInput" ID="Label5" runat="server" Text="Historico Distribucion" Style="font-weight: 700"></asp:Label>
                                <br />
                                <div class="row">
                                    <div class="col-md-3">
                            ...
                            <div class="tab-pane fade" id="edicion">
                                <asp:Label class="control-label" for="focusedInput" ID="Label6" runat="server" Text="Actualizar Distribucion por Fecha" Style="font-weight: 700"></asp:Label>
                                 <br />
                                <asp:Panel ID="panel1" runat="server">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" runat="server" id="div1">
                                            ...
                                            <div class="col-md-5">
                                                <asp:Label ID="Label7" runat="server" Font-Bold="True" ForeColor="Blue" Text="Cargar Achivo:  "></asp:Label>
                                                <asp:FileUpload ID="FileUpload1" runat="server" />
                                            </div>
                                            <div class="col-md-2">
                                                <asp:Button ID="Button3" Class="btn btn-success" runat="server" Text="Procesar" OnClick="Button3_Click" />
                                            </div>
                                            <div class="col-md-2">
                                                <asp:Button ID="Button5" Class="btn btn-success" runat="server" Text="Guardar" OnClick="Button5_Click" Visible="false" />
                                            </div>
                                        </div>
                                    </div>
                                    <br />
                            ...
                            <div class="tab-pane fade " id="baja">
                                <asp:Label class="control-label" for="focusedInput" ID="Label4" runat="server" Text="Remover Empleado" Style="font-weight: 700"></asp:Label>
                                <br />
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <asp:GridView ID="gvtraslados" class="table table-striped table-hover" runat="server" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Depto">
                                                    <ItemTemplate>                                                        
                                                       <asp:TextBox ID="txDepto" class="form-control" ReadOnly="true" runat="server" Text='<% # Bind("nombre_depto")%>'></asp:TextBox>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="50px" />
                                                </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="Op.">
                                                    <ItemTemplate>                                                        
                                                       <asp:TextBox ID="txOperacion" class="form-control" ReadOnly="true" runat="server" Text='<% # Bind("operacion")%>'></asp:TextBox>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="50px" />
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Porcentaje">
                                                    <ItemTemplate>                                                       
                                                        <asp:TextBox ID="txtPorcentaje" class="form-control" Text='<% # Bind("porcentaje_opera")%>' Width="100px" DataFormatString="{0:0.00}"
                                                            onkeypress="return soloNumeros(event)" autocomplete="off" runat="server"></asp:TextBox>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="100px" />
                                                </asp:TemplateField>
