<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VVacacionesDetalleActivos.aspx.cs" Inherits="NominaRRHH.VVacacionesDetalleActivos" %>
        ...
        <div class="panel panel-info">
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <label  class="control-label" for="focusedInput" aria-busy="False" style="font-size: large; font-weight: bold; font-style: normal; color: #3399FF; font-family: Arial, Helvetica, sans-serif"><strong>Reporte General Vacaciones</strong></label>
                        </div>
                    </div>
                </div>
                <br />
                 <div class="row">
                    <div class="col-md-12">   
                          <div class="col-md-2">
                              ...
                              <div class="col-md-2" runat="server" id="filtro">
