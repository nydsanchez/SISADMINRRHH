<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AsignacionDeduccionesComedor.aspx.cs" Inherits="NominaRRHH.Presentacion.AsignacionDeduccionesComedor" %>
    ...
    <div class="container mar-top">
        <div class="panel panel-info">
            <div class="panel-body">
                 ...
                 <div class="row">
                                <div class="col-md-12 paddingContentTabs">
                                    ...
                                    <div class="col-md-4">
                                           ...
                                           <asp:HiddenField ID="Txtingresodisp" runat="server" />
                        <div id="editarhide2" runat="server">
                        <div class="col-md-1" runat ="server" >
                            <label class="control-label" for="focusedInput">Periodo</label>
                            <asp:TextBox ID="txtPeriodo" class="form-control" runat="server" onkeypress="return soloNumeros(event)" autocomplete="off" ReadOnly="true"></asp:TextBox>
                        </div>
                         </div>
                ...
                <br />
                 <%--<label class="control-label" for="focusedInput">Ingresos del Asociado</label>--%>
                  <div class="row">
                     
                        <div class="col-md-12">
                             <div class="col-md-3" runat="server" visible="false">
                            <label class="control-label" for="focusedInput">Promedio por Periodo</label>
                            <asp:TextBox ID="TxtNetoProm" class="form-control" ReadOnly="true"
                                runat="server" autocomplete="off" ></asp:TextBox>
                        </div>
                            
                              <div class="col-md-3" runat="server" visible="false">
                            <label class="control-label" for="focusedInput">Acumulado en Liquidacion</label>
                            <asp:TextBox ID="Txtliquidaciondisp" class="form-control" ReadOnly="true"
                                runat="server" autocomplete="off"></asp:TextBox>
                                   <asp:HiddenField runat="server" ID="hfaculiq" />
                        </div>
                        </div>
                    </div>  
                <br />              
