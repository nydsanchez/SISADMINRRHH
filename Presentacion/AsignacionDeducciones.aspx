<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AsignacionDeducciones.aspx.cs" Inherits="NominaRRHH.Presentacion.AsignacionDeducciones" %>
              ...
              <%--  <div class="row">
                ...
                <div class="row">
                    <div runat="server" id="editarhide5">
                        ...
                        <asp:Button ID="btnSkip" Class="btn btn-danger" Style="margin-top: 22px;" runat="server" Visible="false" Text="Saltar Periodo" OnClick="btnSkip_Click" />
                    </div>
                        </div>
                </div>
                <br />
                  <div class="row">
                        <div class="col-md-12">
                             ...
                             <div class="col-md-3">
                            <label class="control-label" for="focusedInput">Ingreso Estimado Disponible</label>
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="col-md-12">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#activas" data-toggle="tab" aria-expanded="true">Activas</a></li>
                            <li class=""><a href="#inactivas" data-toggle="tab" aria-expanded="false">Inactivas</a></li>
                        </ul>
                        <div id="myTabContent" class="tab-content paddingTab">
                            <div class="tab-pane fade active in" id="activas">
                          <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="GVDeducciones" class="table table-striped table-hover" runat="server" DataKeyNames="tipoDeduc"
                            ...
                            AllowPaging="True" AllowSorting="True" OnRowDeleting="GVDeducciones_RowDeleting" OnSelectedIndexChanged="GVDeducciones_SelectedIndexChanged" 
                            OnRowDataBound="GVDeducciones_RowDataBound" OnPageIndexChanging="GVDeducciones_PageIndexChanging">
                    ...
                    <div class="row" style="margin-top:10px;">
                          <asp:GridView ID="GvEgresos" class="table table-striped table-hover" runat="server"
                            ...
                            <div class="tab-pane fade" id="inactivas">
                                <asp:GridView ID="Gvinactivas" class="table table-striped table-hover" runat="server" DataKeyNames="tipoDeduc"
                            AutoGenerateColumns="False" CellPadding="2" GridLines="Vertical" ShowFooter="True" 
                            BorderStyle="None" BorderWidth="1px" EmptyDataText="No hay Datos"
                            AllowPaging="True" AllowSorting="True" OnRowCommand="Gvinactivas_RowCommand" OnPageIndexChanging="Gvinactivas_PageIndexChanging">
                            <AlternatingRowStyle Width="100px" />
                            <Columns>                               
                                 <asp:BoundField DataField="id" HeaderText="ID">
                                    <ItemStyle Width="5px" HorizontalAlign="Left" />
                                ...
                                <asp:TemplateField HeaderText="Editar">
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnReactivar"
                                                            CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                                            CommandName="reactivar" runat="server" Text="Reactivar" />
                                                    </ItemTemplate>
