<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteEficienciaAPI.aspx.cs" Inherits="NominaRRHH.ReporteEficienciaAPI" %>
        ...
        <%--<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=12.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91" Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>--%>
                ...
                <div class="row" visible="true" runat="server">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnBuscar" Visible="true" Class="btn btn-info" runat="server" Text="Buscar" Style="margin-top: 25px;" OnClick="btnBuscar_Click" />

                        </div>
                        <div class="col-md-1">
                                      
                                            <div ID="btnExport" Class="btn btn-info" Style="margin-top: 25px;">Exportar</div>
