<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AsignacionIngrYDeduc.aspx.cs" Inherits="NominaRRHH.Presentacion.AsignacionIngrYDeduc" %>
                    ...
                    <div class="col-md-12 ">
                        <div class="col-md-2">
                            ...
                            <asp:TextBox ID="txtCodigo" class="form-control" autocomplete="off" TabIndex="4"
                                runat="server" OnTextChanged="txtCodigo_TextChanged"></asp:TextBox>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2" runat="server" id="divIngrs" visible="false">
                            ...
                            <asp:DropDownList class="form-control" ID="ddlTipoIngrs" runat="server" TabIndex="7" OnSelectedIndexChanged="ddlTipoIngrs_SelectedIndexChanged" AutoPostBack="true">
                            </asp:DropDownList>
                        </div>
                        ...
                        <div class="col-md-2" id="divtotal" runat="server" visible="false">
                        ...
                        <div class="col-md-2" id="divhex" runat="server" visible="false">
                            ...
                            <Columns>
                               <%-- <asp:CommandField ShowSelectButton="true" ButtonType="Link" SelectText="Sel">
                                ...
                                <asp:TemplateField HeaderText="IdDevengado">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtIdDevengado" Style="width: 50px;" class="form-control" autocomplete="off" ReadOnly="true" runat="server" Text='<% # Bind("idDevengado")%>'></asp:TextBox>
                                    </ItemTemplate>
                                    <ItemStyle Width="10px" />
                                </asp:TemplateField>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <asp:GridView ID="GVDetNomEmpl" class="table table-striped table-hover" runat="server" Style="width: 100%;"
                            ...
                            BorderStyle="None" BorderWidth="1px" EmptyDataText="No hay Datos"
                            OnRowCommand="GVDetNomEmpl_RowCommand">
                            <AlternatingRowStyle Width="100px" />
                            <Columns>
                             <%--   <asp:CommandField ShowSelectButton="true" ButtonType="Link" SelectText="Sel">
                                    <ControlStyle Width="5px" />
