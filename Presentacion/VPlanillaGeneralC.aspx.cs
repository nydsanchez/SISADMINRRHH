...
{
    public partial class VPlanillaGeneralC : System.Web.UI.Page
    {
        #region REFERENCIAS
        ...
        protected void btnProcesar_Click(object sender, EventArgs e)
        {
            if (txtPeriodo.Text.Trim().Length != 0)
            {
                ...
                if (ChkConsolida.Checked)//reporte consolidad dos periodos
                {
                    ...
                    {
                        ds = Neg_Informes.PlanillaResumenPeriodoCSel(Convert.ToInt32(txtPeriodo.Text.Trim()), Convert.ToInt32(txtPeriodo2.Text.Trim()), 1,0);
                    }
                }
                else
                {
                    ds = Neg_Informes.CargarPlanillaConsolidada(Convert.ToInt32(txtPeriodo.Text.Trim()), 10, 1,0);
                }
                ...
                {            
                    ...
                    decimal neto = Convert.ToDecimal(Empleados.Rows[i]["neto"]);
