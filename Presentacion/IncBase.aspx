<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IncBase.aspx.cs" Inherits="NominaRRHH.Presentacion.IncBase" %>
                ...
                <asp:Panel ID="plnEditarT" runat="server">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-2">
                                <label class="control-label" for="focusedInput">Docenas desde:</label>
                                <asp:TextBox ID="txtDzDesde" class="form-control"
                                    runat="server" onkeypress="return soloNumeros(event)" autocomplete="off"></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                            <label class="control-label" for="focusedInput">Docenas hasta:</label>
                            <asp:TextBox ID="txtDzHasta" class="form-control"
                            runat="server" onkeypress="return soloNumeros(event)" autocomplete="off"></asp:TextBox>
                            </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">                         
                     ...
                     <div class="row">
                        <div class="col-md-5">
                                ...
                                <asp:Button ID="btnGuardar" Class="btn btn-success" Style="margin-top: 22px;" runat="server" Text="Agregar" OnClick="btnGuardar_Click" />
                                <asp:Button class="btn btn-danger btnagregarPermiso" ID="btnEliminar" Text="Eliminar" runat="server" OnClick="btnEliminar_Click" />
                            </div>
                         </div>
                </asp:Panel>
                <br />
