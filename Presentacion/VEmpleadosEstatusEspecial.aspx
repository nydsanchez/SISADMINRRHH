<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VEmpleadosEstatusEspecial.aspx.cs" Inherits="NominaRRHH.Presentacion.VEmpleadosEstatusEspecial" %>
        ...
        <div class="panel panel-info">
            <div class="panel-body" style="margin-top: 0px">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <label  class="control-label" for="focusedInput" aria-busy="False" style="font-size: large; font-weight: bold; font-style: normal; color: #3399FF; font-family: Arial, Helvetica, sans-serif"><strong>Empleados en Condicion Especial</strong></label>
                        </div>
                    </div>
                </div>
