...
{
    public partial class CooLimpiarSaldo : System.Web.UI.Page
    {
        #region REFERENCIAS
       ...
       void MessageError(string msg)
        ...
        protected void btnLimpiarSaldo_Click(object sender, EventArgs e)
        {
            if (validar() == true)
            {
                int codigo = int.Parse(txtCodigo.Text.Trim());
                string msg = new Neg_Cooperativa().LimpiarSaldo(codigo);
