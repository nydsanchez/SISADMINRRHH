...
{
    public partial class ComprobanteViatico : System.Web.UI.Page
    {
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dt = Neg_Informes.ObtenerPersonalPagoViatico(int.Parse(txtperiodo.Text.Trim()), 1,ini,fin,filtro,valorFiltro,ddlProceso.SelectedItem.Text.Trim(),codigo);
                html = Neg_Informes.CrearHojaViaticoHTML(int.Parse(txtperiodo.Text.Trim()), ini, fin, dt,false);
                CrearPDF(html);
