<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VIngresos.aspx.cs" Inherits="NominaRRHH.Presentacion.VIngresos" %>
        ...
        <div class="panel panel-info">
            <div class="panel-body" style="margin-top: 0px">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2">
                            <label class="control-label" for="focusedInput"><strong>Detalle de Ingresos y Egresos</strong></label>
                        </div>
                    </div>
                </div>
                <div class="row">
