<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VPlanillas.aspx.cs" Inherits="NominaRRHH.Reportes.VPlanillas" %>
        ...
        <div class="panel panel-info">
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                     <%--   <div class="col-md-2">
                            <label class="control-label" for="focusedInput">Tipo de Planilla</label>
                            <asp:DropDownList class="form-control" ID="ddlTipoPlanilla" runat="server">
