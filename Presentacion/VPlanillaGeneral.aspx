<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VPlanillaGeneral.aspx.cs" Inherits="NominaRRHH.Presentacion.VPlanillaGeneral" %>
            ...
            <div class="panel-body">
                ...
                <div class="row">                 
                 ...
                 <%--        <div class="col-md-2">
                     ...
                     <div class="col-xs-3">
                            <label class="control-label" for="focusedInput">Por Contrato</label>
                            <asp:DropDownList class="form-control" ID="ddlContrato" runat="server">
                            </asp:DropDownList>
                        </div>
                       <%-- <div class="col-md-2">
