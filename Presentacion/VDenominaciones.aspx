<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VDenominaciones.aspx.cs" Inherits="NominaRRHH.Presentacion.VDenominaciones" %>
    ...
    <div class="container mar-top">
        <div class="panel panel-info">
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <label class="control-label" for="focusedInput">Pagos en efectivo </label>
&nbsp;</div>
                    <div class="col-md-12">
                        <div class="col-md-2">
