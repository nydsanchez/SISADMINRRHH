<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VPermisos.aspx.cs" Inherits="NominaRRHH.Presentacion.VPermisos" %>
        ...
        <div class="panel panel-info">
            <div class="panel-body" style="margin-top: 0px">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2">
                            <label class="control-label" for="focusedInput"><strong>Detalle de Permisos</strong></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12" style="200px">
                         <div class="col-md-3">
                            <label class="control-label" for="focusedInput">Tipo de Permiso</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div>
                            ...
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1115px" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
