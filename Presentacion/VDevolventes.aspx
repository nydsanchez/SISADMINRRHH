<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VDevolventes.aspx.cs" Inherits="NominaRRHH.Presentacion.VDevolventes" %>
    ...
    <div class="container mar-top">
        <div class="panel panel-info">
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <label class="control-label" for="focusedInput">DETALLE ADELANTOS</label>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        <div class="form-group col-md-12 col-sm-12 col-xs-12">
                            ...
                            <label class="col-sm-2 col-md-2 col-xs-2 control-label" for="focusedInput">Tipo Deduccion</label>
