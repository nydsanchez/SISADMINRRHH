...
{
    public partial class R_ObtenerMarcas : System.Web.UI.Page
    {
        #region
        ...
        protected void btnMostrar_Click(object sender, EventArgs e)
        {
            ...
            {
                //ObtenerMarcas();
                ObtenerReporte(Convert.ToDateTime(txtFechaIni.Text), Convert.ToDateTime(txtFechaFin.Text), Convert.ToInt32(ddlAsigPerm.SelectedValue), Convert.ToInt32(ddlubicacion.SelectedValue), Convert.ToInt32(ddlProceso.SelectedValue));
            }

        }
        private void ObtenerReporte(DateTime Inicio, DateTime Fin,int filtro,int ubic,int dpto)
        {

            DataTable ds = null;
            ds = Neg_Informes.spMarcasSelxFecha(Convert.ToDateTime(txtFechaIni.Text), Convert.ToDateTime(txtFechaFin.Text),filtro,ubic,dpto);
