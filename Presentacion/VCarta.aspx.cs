...
"de trabajo en dos tantos de un mismo tenor en la ciudad de Diriamba, a los d&iacute;as <span " + letra + " > " + Dia + " </span> del mes de <span " + letra + " > " + Mes + " </span> del a&ntilde;o <span " + letra + " > " + Año + " </span> . Para la firma del presente contrato " +
