<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmpleadosRevertirBaja.aspx.cs" Inherits="NominaRRHH.Presentacion.EmpleadosRevertirBaja" MaintainScrollPositionOnPostback="true" %>
                ...
                <div class="row">
                    <div class="col-md-12">                        
                                ...
                                <div class="row">
                                    <div class="col-md-12 ">
                                        <div class="col-md-3">
                                            <asp:Button ID="btnRevertir" Class="btn btn-success" runat="server" Text="Revertir Baja" Style="margin-top: 22px;" OnClick="btnRevertir_Click"/>
                                        </div>
                                    </div>
                                </div>
                                <br />
