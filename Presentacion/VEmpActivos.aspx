<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VEmpActivos.aspx.cs" Inherits="NominaRRHH.Presentacion.VEmpActivos" %>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3">
                            ...
                            <asp:DropDownList class="form-control" ID="ddlTipo" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlTipo_SelectedIndexChanged">
                                ...
                                <asp:ListItem Value="3">Altas BAC</asp:ListItem>
