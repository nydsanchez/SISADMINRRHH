<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmpleadosSinMarcaEntradaXDia.aspx.cs" Inherits="NominaRRHH.EmpleadosSinMarcaEntradaXDia" %>
            ...
            <div class="panel-body">--%>
                ...
                <div class="row" visible="true" runat="server">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnEditar" Visible="true" Class="btn btn-info" runat="server" Text="Generar" Style="margin-top: 25px;" OnClick="btnEditar_Click" />
                        </div>                        
                    </div>
