<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ComprobanteConsolida.aspx.cs" Inherits="NominaRRHH.Presentacion.ComprobanteConsolida" %>
                            ...
                            <div class="checkbox">
                                <label>
                                    ...
                                    <asp:RadioButtonList ID="rbllistImpresion" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="rbllistImpresion_SelectedIndexChanged" AutoPostBack="True" TextAlign="Left">
                                        <asp:ListItem Value="1" Selected="True">Departamento</asp:ListItem>
