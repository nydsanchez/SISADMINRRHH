<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AsignacionDeduccionesExt.aspx.cs" Inherits="NominaRRHH.Presentacion.AsignacionDeduccionesExt" %>
                ...
                <br />
                 <div class="row">
                        ...
                        <div class="col-md-1" runat ="server" >
                            ...
                            <asp:TextBox ID="txtPeriodo" class="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                        </div>
                         </div>
