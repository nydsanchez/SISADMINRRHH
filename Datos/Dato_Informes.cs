...
namespace Datos
{
    public class Dato_Informes
    {
        ...
        //TODO:VHPO
        public DataSet ObtenerEmpleadosPlanillaV14nal(string periodo, string periodo2, DateTime fechaini, DateTime fechafin, string depto, string codigo, bool all, bool efectivo, int idEmpresa, int filtroemail, bool periodoConsolida, bool AllEmpleados)
        {
            SqlConnection sqlConnection = ConnectionRepository.getConnection(idEmpresa);
            DataSet ds = new DataSet();

            using (SqlCommand cmd = new SqlCommand("ObtenerEmpleadosPlanillaSP", sqlConnection))
            {
                cmd.CommandType = CommandType.StoredProcedure;

                // Agregar parámetros
                cmd.Parameters.AddWithValue("@periodo", periodo);
                cmd.Parameters.AddWithValue("@periodo2", periodo2);
                cmd.Parameters.AddWithValue("@fechaini", fechaini);
                cmd.Parameters.AddWithValue("@fechafin", fechafin);
                cmd.Parameters.AddWithValue("@depto", depto ?? (object)DBNull.Value);
                ...
                cmd.Parameters.AddWithValue("@filtroemail", filtroemail);
                cmd.Parameters.AddWithValue("@periodoConsolida", periodoConsolida);
                cmd.Parameters.AddWithValue("@AllEmpleados", AllEmpleados);
